    ...
    <div className='home'>
      <div className="wrapper">
        <motion.div className="text-container" variants={textVarients} initial="initial" animate="animate">
            ...
            <motion.a  href='https://drive.google.com/file/d/1dwOQ4nHefPLMPjv41Z9m6POEI1H8M7QC/view?usp=sharing' target="_blank" variants={textVarients}>View resume</motion.a>
