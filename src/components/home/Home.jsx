    ...
    <div className='home'>
      <div className="wrapper">
        <motion.div className="text-container" variants={textVarients} initial="initial" animate="animate">
            ...
            <motion.a  href='https://drive.google.com/file/d/1rILWzBl6I32dA8WfPv6l_K4DVAKJwpkm/view?usp=sharing' target="_blank" variants={textVarients}>View resume</motion.a>
