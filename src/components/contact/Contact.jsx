...
export default function Contact() {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm('service_ducv0cf', 'template_xodwt5m', formRef.current, {
        publicKey: 'UAgPLXRKFt4Wpu6ZT',
      })
      .then(
        () => {
          setSuccess(true);
    ...
    >
      <motion.div className="text-container" variants={variants}>
        ...
        <motion.div className="item" variants={variants}>
          <h2>Email</h2>
          <span>meghayadav5216@gmail.com</span>
        </motion.div>
        <motion.div className="item" variants={variants}>
          <h2>Phone</h2>
          <span><span className="ink">+91 </span>9694005216</span>
        </motion.div>
      </motion.div>
      <motion.div className="form-container">
        ...
        >
          ...
          <textarea rows="8" placeholder="text" name="message"/>
